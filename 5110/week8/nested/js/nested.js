...
document.querySelector('#asteroid').innerHTML = "The asteroid named Helen is between " + asteroid.estimated_diameter.miles.estimated_diameter_min + " and " + asteroid.estimated_diameter.miles.estimated_diameter_max + " wide, and will miss striking Earth by approximately " + asteroid.close_approach_data[0].miss_distance.miles + ".";

document.querySelector('#link').innerHTML = "<a href=" + asteroid.links.self + ">Click here to check out its webpage!</a>";
